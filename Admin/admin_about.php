    ...
    <div class="col-sm-9">
      <div id="perfil_conteudo">
        <div id="tabs" class="tabs">
         <nav>
          <ul>
           <li><a href="#section-1" class="icon-shop"><span>Cadastrar About</span></a></li>
           <li><a href="#section-2" class="icon-cup"><span>Listar About</span></a></li>         
          </ul>
        </nav>
    <div class="content">
          ...
          <form class="form-horizontal" method="post" action="#" enctype="multipart/form-data" id="formulario_admin">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="titulo_about" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Foto</label>
                  <div class="col-sm-10">
                    <input type="file" class="form-control"  name="imagem_about" required>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <textarea name="descricao_about"></textarea>
                  </div>
                </div>
